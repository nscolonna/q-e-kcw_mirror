...
SUBROUTINE kcw_psymdvscf (dvtosym)
  !-----------------------------------------------------------------------
  !
  ! Symmetrization of the response charge density. Wrapper for parallel 
  ! execution of kcw_symdvscf. 
  ! Adapted from PHonon/PH/psymdvscf.f90 and /HP/src/hp_psymdvscf.f90
  !
  USE kinds,             ONLY : DP
